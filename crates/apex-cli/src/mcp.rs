...
mod tests {
    ...
    fn validate_target_path_rejects_traversal_string() {
        // A traversal path that doesn't resolve to a real path should fail.
    ...
    fn validate_target_path_accepts_existing_dir() {
        // /tmp always exists on Unix; on macOS it resolves through /private/tmp.
    ...
    fn validate_target_path_resolves_to_absolute() {
        // Use a known temp dir that is guaranteed to exist.
